...
| What one 50-rider race room actually costs in CPU, memory and bandwidth, and what the number does NOT include | [`docs/spikes/0006-race-room-under-workerd.md`](docs/spikes/0006-race-room-under-workerd.md), [#464](https://github.com/openzigs/onyourleft/issues/464) |
| Why a race room's fan-out latency and its runtime latency are two different numbers | [`docs/spikes/0006-race-room-under-workerd.md`](docs/spikes/0006-race-room-under-workerd.md) §5 |
