...
/**
 * The realistic page's clock and its error guard — #457, #430.
 *
 * Grown from #457's spike page, where it was found on the tablet.
 *
 * ## Why this is its own module
 *
 * On the Pixel Tablet the first version of the page never drew a realistic
 ...
 * rendered, `__oylRealistic.errors` stayed empty, and `ready` stayed false.
 *
