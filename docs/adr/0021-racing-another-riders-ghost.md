...
|---|---|
| *"archived performance data … **previously generated by the other users**"* ('026 cl. 1) | ⚠️ **PRESENT.** This is the limitation D4 names and it is met. It is the reason D4 exists |
...
carries the whole distance for a live race**, plus the *ranked list* element independently. So the
remaining distance is **two independent limitations in '026, and three or four in '224 and '521**,
not the one D4's sentence implies.
