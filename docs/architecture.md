...
**The next free number is 0024.** Every number from 0001 to 0020 is written, 0022 was taken by #340, 0023 by #357, and **0021 is a live reservation** — #330 claimed it before #340 was filed and has not written it yet. ⚠️ This sentence said *"the next free number is 0021"* and that #64 had consumed the last reservation, which was true when #238 wrote it and stopped being true the moment #330 was opened. #340 took **0022** rather than 0021 for that reason: a written ADR cannot be renumbered without breaking citations, so the collision would have landed on #330 rather than here. ⚠️ This sentence then said *"the next free number is 0023"*, which #357 consumed; the reservation is still open and still unwritten.
