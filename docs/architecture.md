...
**0021 is absent because it is reserved and not yet written** — see its row below, and note that
this list is therefore no longer contiguous.
...
| 0021 | #330 — superseding ADR 0007 D4's ban on racing another rider's ghost | **Reserved, not written.** ⚠️ This is the first live reservation since #64 consumed 0012, and it is why [#340](https://github.com/openzigs/onyourleft/issues/340) took 0022. Claimed before #340 was filed, while both this file and `CLAUDE.md` §7 still said 0021 was free with no reservation — the check `CLAUDE.md` §7 asks for is this table, so a claim that never reaches it is a claim that cannot be checked. |
...
**The next free number is 0032.** Every number from 0001 to 0020 is written, 0022 was taken by #340, 0023 by #357, 0024 by #403, 0025 by #432, 0026 by #431, 0027 by #483, 0028 by #465, 0029 by #378, 0030 by #379, 0031 by #380, and **0021 is a live reservation** — #330 claimed it before #340 was filed and has not written it yet. ⚠️ This sentence said *"the next free number is 0021"* and that #64 had consumed the last reservation, which was true when #238 wrote it and stopped being true the moment #330 was opened. #340 took **0022** rather than 0021 for that reason: a written ADR cannot be renumbered without breaking citations, so the collision would have landed on #330 rather than here. ⚠️ This sentence then said *"the next free number is 0023"*, which #357 consumed, and then *"0024"*, which [#403](https://github.com/openzigs/onyourleft/issues/403) consumed with [ADR 0024](adr/0024-offline-and-caching-posture.md), and then *"0025"*, which [#432](https://github.com/openzigs/onyourleft/issues/432) consumed with [ADR 0025](adr/0025-app-store-additional-permission.md), and then *"0026"*, which [#431](https://github.com/openzigs/onyourleft/issues/431) consumed with [ADR 0026](adr/0026-realistic-game-world.md), and then *"0027"*, which [#483](https://github.com/openzigs/onyourleft/issues/483) consumed with [ADR 0027](adr/0027-a-tab-left-behind-by-another-tabs-update.md), and then *"0028"*, which [#465](https://github.com/openzigs/onyourleft/issues/465) consumed with [ADR 0028](adr/0028-racing-fairness.md), and then *"0029"*, which [#378](https://github.com/openzigs/onyourleft/issues/378) consumed with [ADR 0029](adr/0029-camera-imagery-as-a-data-class.md), and then *"0030"*, which [#379](https://github.com/openzigs/onyourleft/issues/379) consumed with [ADR 0030](adr/0030-what-the-app-may-say-about-a-body.md), and then *"0031"*, which [#380](https://github.com/openzigs/onyourleft/issues/380) consumed with [ADR 0031](adr/0031-model-licences-and-the-hosted-model-hole.md); a reviewer who remembers this sentence offering 0026 to 0031 is reading the old file. The reservation is still open and still unwritten.
