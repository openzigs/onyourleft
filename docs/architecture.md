...
| [0028](adr/0028-racing-fairness.md) | How a race is fair — one physics for everyone, a room that re-simulates and wins, declared weight with W/kg categories, no drafting in the first cut, and five questions left to the owner | #465 |
